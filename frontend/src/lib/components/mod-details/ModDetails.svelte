<script lang="ts">
  ...
  import { mdiChatProcessing, mdiCheck, mdiChevronDown, mdiImport, mdiRobot, mdiRobotOff, mdiRocketLaunch, mdiTestTube, mdiWeb } from '@mdi/js';
  ...
  import { AiUseDisclosureType, CompatibilityState, GetModDetailsDocument } from '$lib/generated';
